                    ...
                    friendRequest?.map(({_id, requestFrom : from}) =>(
                      ...
                      className='flex items-center justify-between'>
                        ...
                        <div className='flex gap-1'>
                            <CustomButton
                             title= 'Accept'
                             containerStyle='bg-[#0444a4] text-xs text-white px-1.5
                             py-1 rounded-full'
                            />
                            <CustomButton
                             title= 'Deny'
                             containerStyle='border border-[#666] text-xs text-ascent-1 px-1.5
                             py-1 rounded-full'
                            />
                        </div>
                      </div>
                ...
                <div className='w-full flex flex-col gap-4 pt-4'>
                  {
                    suggestedFriends?.map((friend)=> (
                      ...
                      >
                        ...
                        <div className='flex gap-1'>
                          <button
                            className='bg-[#0444a430] text-sm text-white-white p-1
                            rounded'
                            onClick={()=> {}}
                          >
