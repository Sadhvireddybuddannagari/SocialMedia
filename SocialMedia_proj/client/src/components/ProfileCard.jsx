...
import { BsPersonFillAdd , BsBriefcase, BsFacebook, BsInstagram} from 'react-icons/bs';
...
const ProfileCard = ({user}) => {
  ...
  return (
    <div>
      <div className='w-full bg-primary flex flex-col items-center shadow-5m
